...
export async function POST(req: Request) {
  try {
    ...
    // Extraction des informations personnelles pour l'email utilisateur
    const { nom, prenom, email, telephone, ville } = personalInfo;
    ...
    // Fonction pour récupérer le label du permis
